...
function successMessage(interaction, text, ephemeral = false) {
  if (!interaction) {
    throw Error("'interaction' param olarak aktarılmalıdır! (successMessage)");
  }

  if (!text) {
    throw Error("'text' param olarak aktarılmalıdır! (successMessage)");
  }
...
function warnMessage(interaction, text) {
  if (!interaction) {
    throw Error("'interaction' param olarak aktarılmalıdır! (warnMessage)");
  }

  if (!text) {
    throw Error("'text' param olarak aktarılmalıdır! (warnMessage)");
  }
...
function errorMessage(interaction, text) {
  if (!interaction) {
    throw Error("'interaction' param olarak aktarılmalıdır! (errorMessage)");
  }

  if (!text) {
    throw Error("'text' param olarak aktarılmalıdır! (errorMessage)");
  }
...
function queueMessage(queue, text, color) {
  if (!queue) {
    throw Error("'queue' param olarak aktarılmalıdır! (queueMessage)");
  }

  if (!text) {
    throw Error("'text' param olarak aktarılmalıdır! (queueMessage)");
  }
